...
## Що ще корисного вже є

UkrCode не лише про ботів — мова вже має корисні штуки для реальної роботи:
...
Так можна швидко зібрати простий API або локальний веб-сервіс для інтерфейсу,
адмінки або проміжного бекенду. Для складніших задач можна використовувати
Python прямо в `.ucod` файлі:
...
Так можна підключити майже будь-яку Python-бібліотеку або власний рушій без
переходу на іншу мову. Для реальних проєктів є також SQLite, JSON, файли,
сесії, пакети і локальні бібліотеки.
